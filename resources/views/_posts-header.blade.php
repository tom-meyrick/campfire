    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            <div x-data="{ show: false, }">
                <button @click="show = ! show" @click.away="show = false" class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w32 text-left flex lg:inline-flex">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl z-50" style="display:none">
                    ...
                    <a href="/categories/{{ $category->slug }}" class="block text-left px-3 
                        text-sm leading-6 hover:bg-blue-500 
